...
import graphguide.GraphGuideV2;
...
import dataguide.ValueNode;
	...
	public class OverlappingGuidesV2 {

		public static int NumberofInputvalues = 0;
		GraphGuideV2 graphG = null;
		...
		public OverlappingGuidesV2(GraphGuideV2 graphG, DataGuide dataG,
		...
		//		System.out.println("MPIKE STI WHILE!");
				...
				if (comp < 0) {
					pq1.poll();
				//	System.out.println("Value q1: "+peek1.normalizedName);
				} else if (comp > 0) {
					pq2.poll();
				//	 System.out.println("Value q2: "+peek2.normalizedValue); 
				} else {
					/**
...
//							+ peek2.normalizedValue + "   Property: "+peek1.relationPathFromRoot+"\tXML Path: "+peek2.parent.getStringPathRootToNode());
...
//					}
		...
		public static void main(String[] args) throws Exception {
			...
			HashMap<String, GraphGuideV2> graphGuides = new HashMap<String, GraphGuideV2>();
					...
					try (BufferedReader br = new BufferedReader(new FileReader(
						...
						while ((sCurrentLine = br.readLine()) != null) {
							...
							if (graphGuides.containsKey(columns[1])) {
								...
								graphG.parseInputsEntitiesFile(columns[1],lineColumns[3]);
...
//									+ columns[0].replace(" ", "+"));
		...
		//					pathPairsSetWithValues = new HashSet<String>();
							...
							OverlappingGuidesV2 ov = new OverlappingGuidesV2(graphG,
			...
			//				addTototalPathsWithValues();
				...
				System.out.println("\n\n\nTotal execution time: "
						+ (float)((endTime - startTime) / 1000) / 60);
			}// try
		}
